...
public class GameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        puzzle = getPuzzle(diff);               //接收一次难度级别并返回一次数独游戏
        Log.e(TAG,"onCreate11" + diff);
        calculateUsedTiles();
        Log.d(TAG,"onCreate22" + diff);
        puzzleView = new PuzzleView(this);
        setContentView(puzzleView);
        puzzleView.requestFocus();
        getIntent().putExtra(KEY_DIFFICULTY,DIFFICULTY_CONTINUE);   //恢复已经保存的游戏
    ...
    public void showKeyPadOrError(int x, int y){
        ...
        if(tiles.length == 9){
            ...
            Log.e(TAG,"showKeyPad:used="+toPuzzleString(tiles));
    ...
    static protected int[] fromPuzzleStrig(String string){
